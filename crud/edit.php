...
<?php include ("./layout/meniu.html");?>
  <div class="container-md w-50 p-3">
    ...
    <form method="post" action="http://localhost/cgaplicatie/crud/post_update.php?idutilizator=<?php echo $row['id'];?>"  enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
     <input type="hidden" name="idutilizator value=<?php echo $row['id'];?>">
      ...
      <div class="col-md-12">
        ...
        <input name="datanastere" type="date" class="form-control" id="validationCustom05" value="<?php echo $row['datanastere'];?>">
        <div class="valid-feedback">
          Camp completat corect.
        </div>
        <div class="invalid-feedback">
      ...
      <div class="col-md-12">
          <img style="max-width:50px;" src="./uploads/<?php echo $row['poza'];?>" alt="">
